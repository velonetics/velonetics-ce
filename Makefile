...
test-auth:
	set "GOWORK=" && cd ../pucora-apikeys && go test ./...
	set "GOWORK=" && cd ../pucora-basicauth && go test ./...
	set "GOWORK=" && cd ../pucora-gcp-auth && go test ./...
	set "GOWORK=" && cd ../pucora-aws-sigv4 && go test ./...
	set "GOWORK=" && cd ../pucora-ntlm && go test ./...
	set "GOWORK=" && cd ../pucora-revoker && go test ./...
	set "GOWORK=" && cd ../pucora-jwk-aggregator && go test ./...
